...
SIGNIN_IDENTIFIER = RateLimitPolicy('signin_identifier', 5, 900)
...
PASSWORD_CHANGE_USER = RateLimitPolicy('password_change_user', 5, 900)
CONTACT_CHANGE_USER = RateLimitPolicy('contact_change_user', 8, 900)
CONTACT_CHANGE_TARGET = RateLimitPolicy('contact_change_target', 5, 900)
